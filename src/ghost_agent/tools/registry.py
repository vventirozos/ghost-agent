...
TOOL_DEFINITIONS = [
    ...
    {"type": "function", "function": {"name": "file_system", "description": "Unified file manager (list, read, write, download).", "parameters": {"type": "object", "properties": {"operation": {"type": "string", "enum": ["list", "read", "write", "download"]}, "path": {"type": "string"}, "content": {"type": "string"}, "url": {"type": "string"}, "filename": {"type": "string"}}, "required": ["operation"]}}},
...
def get_available_tools(context):
    return {
        ...
        "learn_skill": lambda **kwargs: tool_learn_skill(skill_memory=context.skill_memory, **kwargs),
